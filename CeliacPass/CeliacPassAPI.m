...
@implementation CeliacPassAPI

+ (CeliacPassAPI *)sharedInstance {

    static CeliacPassAPI *sharedInstance = nil;
    static dispatch_once_t oncePredicate;
    dispatch_once(&oncePredicate, ^{
        sharedInstance = [CeliacPassAPI new];
    });
